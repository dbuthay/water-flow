...
**Plans:** 2 plans
Plans:
- [ ] 05-01-PLAN.md — Wave 0 test stubs + coordinator leak detection engine (transitions, ramp-up, threshold, shutoff, notifications)
...
| 5. Leak Detection | 0/2 | Planning complete | - |
